...
\subsection*{Más avanzados}
    ...
    % \input{cp3/exercises/print_numbers}
...
% Advanced
    ...
    \input{cp4/exercises/is_palindrome}

    \item \textbf{Mediana}\\
    \input{cp4/exercises/median}
...
% Intermediate
    ...
    \input{cp4/exercises/reverse_array}

    \item \textbf{Filtrando positivos}
    \input{cp4/exercises/filter_positive_numbers}

    \item \textbf{Subarray}\\
    \input{cp4/exercises/subarray}

    \item \textbf{Operaciones sobre arrays}
    \input{cp4/exercises/modifying_arrays}

\subsection*{Más avanzados}
% Advanced
     \item \textbf{Rotando arrays}\\
    \input{cp4/exercises/rotate_array}

    \item \textbf{Invirtiendo bloques}\\
    \input{cp6/exercises/reverse_subarrays}

    \item \textbf{Mezcla ordenada}\\
    \input{cp4/exercises/merge_sorted_arrays}

    \item \textbf{Ordenando}\\
    \input{cp4/exercises/sort_array}
